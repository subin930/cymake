...
def s3_connection():
    try:
        ...
        print("s3 bucket connected! uploading beauty news crawl data")
        return s3
...
def upload_beauty():
    ...
    prefix_key_article = 'crawl/beauty/article/' + date_prefix + '/'
    prefix_key_image = 'crawl/beauty/image/' + date_prefix + '/'
    prefix_key_summary = 'crawl/beauty/summary/' + date_prefix + '/'
