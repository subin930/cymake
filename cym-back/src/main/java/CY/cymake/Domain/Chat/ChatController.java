...
public class ChatController {
    ...
    public CommonResult<ChatResDto> chat (@RequestParam(value = "sessionId") String sessionId, @RequestParam(value = "question") String question, @RequestPart(value = "file", required = false) MultipartFile file, @AuthenticationPrincipal CustomUserDetails user) throws IOException {
